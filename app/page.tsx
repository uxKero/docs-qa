...
const SUGGESTIONS = [
  "What does eve.dev say about defining tools?",
  "How do I deploy an Eve agent?",
];
  ...
  return (
    <main className="mx-auto flex h-screen max-w-2xl flex-col px-4">
      <header className="flex items-center justify-between border-b border-border py-4">
        <div>
          <h1 className="text-sm font-semibold tracking-tight">Docs Q&amp;A</h1>
          <p className="text-xs text-muted">An Eve agent that answers from a product&apos;s docs.</p>
        </div>
        <a
          href="https://eve.dev"
          target="_blank"
      ...
      <div ref={scrollRef} className="flex-1 space-y-4 overflow-y-auto py-6">
        {empty ? (
          <div className="flex h-full flex-col items-center justify-center text-center">
            <h2 className="text-lg font-medium tracking-tight">Ask about any product&apos;s docs</h2>
            <p className="mt-1.5 max-w-sm text-sm text-muted">
              Give it a site and a question. It reads the llms.txt / agents.md and answers with sources.
            </p>
      ...
      >
        <div className="flex items-end gap-2 rounded-xl border border-border bg-surface-subtle px-3 py-2 focus-within:border-foreground/30">
          <textarea
            ...
            rows={1}
            placeholder="Ask about a product's docs..."
